...
Roc is software for generating and working with ROC
([Receiver Operating Characteristic](http://en.wikipedia.org/wiki/Receiver_operating_characteristic))
and PR
...
roc, an
[enormous, legendary bird of prey](http://en.wikipedia.org/wiki/Roc_(mythology)).
